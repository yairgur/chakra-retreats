        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            ...
            <ActivityCard
              ...
              description="אחרי שעוררנו את התשוקה שבנו, נצלול אל מחוזות הלב והאהבה שיש בנו ובחיים שלנו ונתינת אהבה אחד.ת לשני.ה. נסיים בטקס קקאו שיחמם לנו את הלב יעלה את האנרגיות ויעיף אותנו למסיבה קבוצתית בגג."
              images={[
                "/images/image10.jpg",
                "/images/image11.jpg",
                "/images/image12.jpg"
